...
def _handle_task_result(
    ...
    # Ad the pylint ignore: we want to handle all exceptions here so that
    # the result of the task is properly logged. There is no point
    # re-raising the exception in this callback.
